...
Токен установки выпускается в админке системы. Он одноразово привязывает устройство к организации — после регистрации агент работает по собственному device-токену.
